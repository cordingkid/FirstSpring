...
<body>
	...
	<div class="container">
		<form name="newUpdate" action="/notice/update.do" class="form-horizontal" method="get" id="newUpdate">
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<p>
						...
						<a href="/notice/list.do" class="btn btn-primary" id="listBtn"> 목록</a>
					</p>
				</div>
			</div>
		</form>
...
// 	var listBtn = $('#listBtn');
	...
	deleteBtn.on('click',function(){
		if(confirm("정말 삭제 하시겠습니까?")){
			newUpdate.attr('action','/notice/delete.do')
